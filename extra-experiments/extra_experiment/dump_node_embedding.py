...
ALL_CONFIGS = {
    'large': {
        ...
        'suffix': 'large_cummunity',
    },
    'middle': {
        'graph_path': 'data_preprocess/full_graph/middle.bin',
        'model_path': 'models/middle.bin',
        'suffix': 'middle_cummunity',
    },
    'little': {
        'graph_path': 'data_preprocess/full_graph/little.bin',
        'model_path': 'models/little.bin',
        'suffix': 'little_cummunity',
    },
}
CONFIG = ALL_CONFIGS[sys.argv[1]]

SPECIAL_SUFFIX = CONFIG['suffix']
...
class ParameterNamespace():
    def __init__(self, special_suffix):
        ...
        if not os.path.exists(self.node_embedding_dir):
            os.makedirs(self.node_embedding_dir, exist_ok=True)
